...
function [hz_01,hz_10,hz_impulse,hx_01,hx_10,hx_impulse,hy_01,hy_10,hy_impulse,ex_01,ex_impulse,ey_01,ey_impulse] = Calculate_Horizontal_Finite_Electrical_Source(I,L,h,x,y,z,t,fine)
u0 = 4*pi*1e-7;
% r = (x^2+y^2).^(0.5);
%% 计算接地项的参数
R1 = ((x+L/2).^2+y.^2).^0.5; 
